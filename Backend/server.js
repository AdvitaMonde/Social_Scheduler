...
app.use(
  cors({
    origin: (origin, callback) => {
      // Allow non-browser requests (no origin), the configured production
      // frontend URL, and any Vercel preview deployment for this project
      // (e.g. https://social-scheduler-<hash>-<user>.vercel.app).
      if (
        !origin ||
        origin === config.frontendUrl ||
        /^https:\/\/social-scheduler-[a-z0-9]+-advita\.vercel\.app$/.test(origin)
      ) {
